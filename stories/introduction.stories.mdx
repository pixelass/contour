...
<img src={logo} style={{ display: "block", margin: "auto", width: "100%", maxWidth: 512 }} />

# Introduction

Contour is a grid-system. Built on css-variables it offers a lightweight implementation with
...
amount of columns for a speciffic section.

You can read more abouzt compound grids in these articles:
